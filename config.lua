...
Config.AdsCategories = {
    ...
    [2] = {
        ...
        job = {"police", "police2"}, -- People with this job name will post all ads to this category.
        jobGrade = 0, -- People with this or higher job grade will post all ads to this category.
    ...
    [5] = {
        ...
        job = {"mechanic", "bennys"}, -- People with this job name will post all ads to this category.
        jobGrade = 0, -- People with this or higher job grade will post all ads to this category.
